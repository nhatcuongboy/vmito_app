...
class OAuthSignInButton extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    final icon = switch (provider) {
      OAuthProvider.google => _googleIcon,
      OAuthProvider.facebook => _facebookIcon,
    };
...
// These paths intentionally match the inline provider marks used by the FE
// sign-in page. They stay as vectors so neither app invents a separate bitmap.
const _googleIcon = '''

...
const _arbToWebPath = <String, String>{
  ...
  'sessionHostInfoTitle': 'session.hostInfo',
  'sessionHostRating': 'session.hostDetail.rating',
  'sessionHostCall': 'session.hostDetail.call',
  'sessionHostZalo': 'session.hostDetail.zalo',
  'sessionHostTotalHosted': 'session.hostDetail.totalHosted',
  'sessionHostOpenSessions': 'session.hostDetail.availableSessions',
  'sessionViewDetails': 'session.viewDetails',
